...
<html>  
<head>  
<%//int [] data1=(int [])request.getAttribute("data");
//int [] xAxis1=(int [])request.getAttribute("xAxis");
ArrayList data1=(ArrayList)request.getAttribute("data");
ArrayList xAxis1=(ArrayList)request.getAttribute("xAxis");
...
<title>show find result</title>  
</head> 
<body>

<div style="background-color:WHITE;width:1200px;height:1300px;">
 

<canvas id="canvas"  width=1200px height=1300px ;></canvas>  
