...
<div style="background-color:WHITE;width:1200px;height:1200px;">
...
context.moveTo(1100, 690);
context.lineTo(1100, 720);
context.moveTo(50, 710);
context.lineTo(540,710);
context.moveTo(660, 710);
context.lineTo(1100,710);

context.stroke();
context.fillStyle = "#00f";
context.font = "italic 20px sans-serif";
var txt="300m-400m"
context.fillText(txt , 545, 715);
//表示距离3
context.strokeStyle="#ff0000";

context.lineWidth=3;
context.beginPath();
context.moveTo(50, 920);
context.lineTo(50, 950);
context.moveTo(1100, 920);
context.lineTo(1100, 950);
context.moveTo(50, 930);
context.lineTo(540,930);
context.moveTo(660, 930);
context.lineTo(1100,930);

context.stroke();
context.fillStyle = "#00f";
context.font = "italic 20px sans-serif";
var txt="400m-500m"
context.fillText(txt , 545, 935);
//表示距离4
context.strokeStyle="#ff0000";

context.lineWidth=3;
context.beginPath();
context.moveTo(50, 1140);
context.lineTo(50, 1170);
context.moveTo(1100, 1140);
context.lineTo(1100, 1170);
context.moveTo(50, 1150);
context.lineTo(540,1150);
context.moveTo(660, 1150);
context.lineTo(1100,1150);

context.stroke();
context.fillStyle = "#00f";
context.font = "italic 20px sans-serif";
var txt="500m-600m"
context.fillText(txt , 545, 1155);
//设置纯色
...
$(document).ready(function() {  
           ...
           for(var i=0;i<(hello.length)/4;i++){
        	   ...
        	   if(hello[i]>600){
        		...
        		//grd.addColorStop(0,"#4CE8B2"); //起始颜色
        		//grd.addColorStop(1,"#EFD458"); //终点颜色
        		context.fillStyle="rgba(0,255,0,0.6)"; //以上面定义的渐变填充
        		context.fill(); //闭合形状并且以填充方式绘制出来
        		context.font = "italic 30px sans-serif";
        		context.fillText(i+1 , x+15, y-5);
        		x=x+70;  
           ...
           for(var i=15;i<(hello.length)/2;i++){
           ...
           for(var i=30;i<(hello.length)*3/4;i++){
